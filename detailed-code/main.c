 ...
 */
 ...
 #include <string.h>
    ...
    */
    ...
    printf("%-17s : %s\n", "Name", name); // -17s is used to left-align the string in a field of width 17 characters. This ensures that the output is neatly formatted and aligned, making it easier to read.
